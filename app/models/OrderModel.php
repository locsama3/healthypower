...
class OrderModel extends Model {
    ...
    public function getAllOrder(){
        return $this->db->table('shop_orders')->select('shop_customers.fullname, shop_orders.*,shop_payment_types.payment_code,shop_order_details.*')->join('shop_payment_types', 'shop_payment_types.id = shop_orders.payment_type_id')->join('shop_customers', 'shop_customers.id = shop_orders.customer_id')->join('shop_order_details', 'shop_orders.id = shop_order_details.order_id')->groupBy('shop_orders.id')->get();
    }
    public function getAllOrderDetail(){
        return $this->db->table('shop_orders')->select('shop_customers.fullname, shop_orders.*, shop_order_details.*')->join('shop_customers', 'shop_customers.id = shop_orders.customer_id')->join('shop_order_details', 'shop_orders.id = shop_order_details.order_id')->groupBy('shop_order_details.id')->get();
    }
