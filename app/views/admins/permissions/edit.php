<!-- ========== MAIN CONTENT ========== -->
    ...
    <main id="content" role="main" class="main">
      ...
      data-uptid = "{{ $permission_by_id['id'] }}">
        {!csrf_field()!}
        <!-- Page Header -->
            ...
            <div class="col-sm mb-2 mb-sm-0">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-no-gutter">
                  <li class="breadcrumb-item"><a class="breadcrumb-link" href="ecommerce-products.html">Quyền hạn</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Thêm quyền hạn</li>
                </ol>
              </nav>

              <h1 class="page-header-title">Thêm quyền hạn</h1>
            </div>
          </div>
          <!-- End Row -->
        </div>
          ...
          <div class="mx-auto col-lg-8">
            ...
            <div class="card mb-3 mb-lg-5">
              ...
              <div class="card-header">
                <h4 class="card-header-title">Thông tin quyền hạn</h4>
              </div>
              <!-- End Header -->
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <label for="title" class="input-label">Tên quyền hạn <i class="tio-help-outlined text-body ml-1" data-toggle="tooltip" data-placement="top" title="Tên quyền hạn"></i></label>

                  <input type="text" class="form-control" name="permissionName" id="title" 
                  value = "{{ $permission_by_id['name'] }}" onkeyup="setTimeout(ChangeToSlug(),2000)">
                  <span class = "form-message">
                    {!form_error('permissionName')!} 
                  </span>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="slug" id="convert_slug" value = "{{ $permission_by_id['slug'] }}">
                </div>
                <!-- End Liên kết tĩnh -->
                ...
                <div class="form-group">
                  ...
                  value = "{{ $permission_by_id['display_name'] }}">                  
                </div>
                <!-- End Tên hiển thị -->
                ...
                <div class="form-group">
                  ...
                  value = "{{ $permission_by_id['guard_name'] }}">
                  <span class = "form-message">
            ...
            <div class="card-body">
              <div class="row justify-content-center justify-content-sm-between">
                ...
                <div class="col-auto">
                  ...
                  <button type="submit" class="btn btn-primary">Cập nhật quyền hạn</button>
                </div>
              </div>
              <!-- End Row -->
            </div>
