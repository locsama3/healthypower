            ...
            <div class="card mb-3 mb-lg-5">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  placeholder="Tên quyền hạn" aria-label="Tên quyền hạn" onkeyup="setTimeout(ChangeToSlug(),2000)">
                ...
                <div class="form-group">
                  ...
                  placeholder="Tên hiển thị" aria-label="Tên hiển thị">                  
                </div>
                <!-- End Tên hiển thị -->
                ...
                <div class="form-group">
                  ...
                  placeholder="Tên bảo mật" aria-label="Tên bảo mật">
                  <span class = "form-message">
            ...
            <div class="card-body">
              <div class="row justify-content-center justify-content-sm-between">
                ...
                <div class="col-auto">
                  ...
                  <button type="submit" class="btn btn-primary">Thêm quyền hạn</button>
                </div>
              </div>
              <!-- End Row -->
            </div>
