        ...
        <div class="page-header">
          <div class="row align-items-center mb-3">
            <div class="col-sm mb-2 mb-sm-0">
              <h1 class="page-header-title">Danh sách Quyền hạn <span class="badge badge-soft-dark ml-2"> {{ $permissionsCount }} </span></h1>
            ...
            <div class="col-sm-auto">
              <a class="btn btn-primary" href="{{_WEB_ROOT.'/permissions-create'}}">Thêm quyền hạn</a>
            </div>
          </div>
          <!-- End Row -->
          ...
          <div class="js-nav-scroller hs-nav-scroller-horizontal">
            ...
            <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" href="#">Danh sách Quyền hạn</a>
              </li>
              <li class="nav-item">
                    ...
                    <div class="card card-sm">
                      <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                          <span class="mr-2">Danh sách Quyền hạn</span>
            ...
            <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
              ...
              <thead class="thead-light">
                <tr>
                  ...
                  <th class="table-column-pl-0">Quyền hạn</th>
                  <th>Tên hiển thị</th>
                  <th>Tên bảo mật</th>
                  <th>Actions</th>
                </tr>
              ...
              <tbody>
                @foreach ($list_permissions as $key => $value)
                <tr id = "row_tr_{{$value['id']}}">
                  ...
                  <td>
                    <div class="btn-group" role="group">
                      ...
                      href="{{_WEB_ROOT.'/permissions-edit/editid-'.$value['id']}}">
