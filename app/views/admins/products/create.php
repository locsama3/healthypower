              ...
              <div class="row">
                <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="length" id="lengthLabel" placeholder="50" aria-label="eg. 348121032">
                    <span class="form-message"></span>
                  </div>
                  <!-- End Form Group -->
                </div>
                ...
                <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="width" id="widthLabel" placeholder="30" aria-label="eg. 348121032">
                    <span class="form-message"></span>
                  </div>
                  <!-- End Form Group -->
                </div>
                ...
                <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="height" id="heightLabel" placeholder="50" aria-label="eg. 348121032">
                    <span class="form-message"></span>
                  </div>
                  <!-- End Form Group -->
                </div>
