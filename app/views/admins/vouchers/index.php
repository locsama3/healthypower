        ...
        <div class="page-header">
          <div class="row align-items-center mb-3">
            <div class="col-sm mb-2 mb-sm-0">
              <h1 class="page-header-title">Danh sách mã khuyến mãi <span class="badge badge-soft-dark ml-2"> {{ $voucherCount }} </span></h1>
            ...
            <div class="col-sm-auto">
              <a class="btn btn-primary" href="{{_WEB_ROOT.'/vouchers-create'}}">Thêm mã khuyễn mãi</a>
            </div>
          </div>
          <!-- End Row -->
          ...
          <div class="js-nav-scroller hs-nav-scroller-horizontal">
            ...
            <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" href="#">Danh sách Mã khuyến mãi</a>
              </li>
              <li class="nav-item">
                    ...
                    <div class="card card-sm">
                      <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                          <span class="mr-2">Danh sách mã khuyến mãi</span>
            ...
            <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
              ...
              <thead class="thead-light">
                <tr>
                  ...
                  <th class="table-column-pl-0">Mã khuyến mãi</th>
                  <th>Số lượng</th>
                  <th>Số lượt sử dụng</th>
                  <th>Số mã/Khách hàng</th>
                  <th>Giá trị</th>
                  <th>Hạn sử dụng</th>
                  <th>Actions</th>
                </tr>
              ...
              <tbody>
                ...
                <tr id = "row_tr_{{$value['id']}}">
                  ...
                  <td class="table-column-pl-0">
                    <a class="media align-items-center" href="ecommerce-product-details.html">
                      <div class="media-body">
                        <h5 class="text-hover-primary mb-0">{{$value['voucher_name']}}</h5>
                      </div>
                    </a>
                    <p style="margin:0">{{$value['voucher_code']}}</p>
                  </td>
                  <td>
                    <div class="media-body">
                      {{$value['max_uses']}}
                  ...
                  <td>{{$value['uses']}}</td>
                  <td>{{$value['max_uses_user']}}</td>
                  <td>
                    {{$value['discount_amount']}}
                    <span class="type_discount">
                      @if ($value['type'] == 1)
                        {{ " đ" }}
                      @else
                        {{ " %" }}
                  ...
                  <td>
                    <p>Từ: {{$value['start_date']}}</p>
                    <p style="margin: 0;">Đến: {{$value['end_date']}}</p>
                  </td>
                  <td>
                    <div class="btn-group" role="group">
                      <a class="btn btn-sm btn-white" 
                      href="{{_WEB_ROOT.'/vouchers-edit/editid-'.$value['id']}}">
