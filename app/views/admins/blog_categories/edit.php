<!-- ========== MAIN CONTENT ========== -->
    ...
    <main id="content" role="main" class="main">
      <!-- Content -->
      <form class="content container-fluid" method="POST" action = "{{_WEB_ROOT.'/blogs-category-update/cateid-'.$blog_cate_by_id['id']}}"
        ...
        <div class="page-header">
          <div class="row align-items-center">
            <div class="col-sm mb-2 mb-sm-0">
              ...
              <h1 class="page-header-title">Cập nhật danh mục bài viết</h1>
            </div>
          </div>
          <!-- End Row -->
        </div>
            ...
            <div class="card mb-3 mb-lg-5">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="blogCateName" id="title" 
                  value="{{ $blog_cate_by_id['name'] }}" aria-label="Tên danh mục" 
                  onkeyup="setTimeout(ChangeToSlug(),2000)">
                  {!form_error('blogCateName', '<span style="color: red; padding-top: 6px; display: block">', '</span>')!}
                </div>
                <!-- End Tiêu đề -->
                ...
                <div class="form-group">
                  ...
                  value="{{ $blog_cate_by_id['slug'] }}" aria-label="">
                </div>
                <!-- End Liên kết tĩnh -->
                ...
                <div class="form-group">
                  ...
                  value="{{ $blog_cate_by_id['page_title'] }}" aria-label="">
                </div>
                <!-- End Tiêu đề website -->
                          ...
                          <select name = "parentCate" class="js-select2-custom custom-select" size="1" style="opacity: 0;" data-hs-select2-options='{
                            ...
                            @foreach ($blog_categories as $key => $value)
                              <option value="{{ $value['id'] }}"
                                @if($value['id'] == $blog_cate_by_id['parent_id'])
                                  {{ "Selected" }}
                                @endif
                              >
                                {{ $value['name'] }}
                ...
                <!-- Quill -->
                <textarea name="cate_desc" id="ckeditor1" cols="30" rows="10" placeholder="Mô tả">{{ $blog_cate_by_id['description'] }}</textarea>
                <!-- End Quill -->
              </div>
              <!-- Body -->
            </div>
              ...
              <div class="card-body">
                ...
                <div id="fancyboxGallery" class="js-fancybox row justify-content-sm-center gx-2" data-hs-fancybox-options='{
                  ...
                  <div class="col-6 col-sm-4 col-md-3 mb-3 mb-lg-5">
                    ...
                    <div class="card card-sm">
                      <img class="card-img-top" src="{{_WEB_ROOT.'/public/uploads/blog_category/'.$blog_cate_by_id['banner']}}" alt="Image Description">
                ...
                <div id="attachFilesNewProjectLabel" class="js-dropzone dropzone-custom custom-file-boxed">
                  <div class="dz-message custom-file-boxed-label">
                    ...
                    <input type="file" name="image_cate" id = "image_cate" class = "hide_input_file">
                  </div>
                </div>
                <!-- End Dropzone -->
              </div>
