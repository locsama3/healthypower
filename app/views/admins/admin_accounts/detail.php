          ...
          <div class="col-lg-10">
            ...
            <div class="text-center mb-5">
              ...
              <div class="avatar avatar-xxl avatar-circle avatar-border-lg profile-cover-avatar">
                <img class="avatar-img" src="{{_WEB_ROOT.'/public/uploads/avatar/'.$admin_by_code['avatar']}}" alt="Image Description">
                <span class="avatar-status avatar-status-success"></span>
              </div>
              <!-- End Avatar -->

              <h1 class="page-header-title">{{ $admin_by_code['fullname'] }} <i class="tio-verified tio-lg text-primary" data-toggle="tooltip" data-placement="top" title="Top endorsed"></i></h1>

              <!-- List -->
              <ul class="list-inline list-inline-m-1">
                <li class="list-inline-item">
                  <i class="tio-city mr-1"></i>
                  <span>Healthy Power</span>
                </li>
                ...
                <li class="list-inline-item">
                  ...
                  <a href="#">
                    @php
                      $str = explode(',', $admin_by_code['address1']);
                    @endphp
                    {{ $str[3] }}
                  </a>
                  <a href="#">, Việt Nam</a>
                ...
                <li class="list-inline-item">
                  ...
                  <span>Tháng
                    @php
                      $strtime = strtotime($admin_by_code['created_at']);
                      $time = date('M Y', $strtime);
                    @endphp
            ...
            <div class="js-nav-scroller hs-nav-scroller-horizontal mb-5">
              ...
              <ul class="nav nav-tabs align-items-center">
                <li class="nav-item">
                  <a class="nav-link active" href="user-profile.html">Thông tin cá nhân</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link " href="user-profile-teams.html">Nhóm</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link " href="user-profile-projects.html">Dự án <span class="badge badge-soft-dark rounded-circle ml-1">3</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link " href="user-profile-connections.html">Liên hệ</a>
                </li>

                <li class="nav-item ml-auto">
                  <a class="btn btn-sm btn-white mr-2" href="#">
                    <i class="tio-user-add mr-1"></i> Liên hệ
                  </a>
                  ...
                  <div class="hs-unfold hs-nav-scroller-unfold">
                    ...
                    <div id="profileDropdown" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right mt-1">
                      ...
                      <a class="dropdown-item" href="#">
                        <i class="tio-share dropdown-item-icon"></i> Chia sẻ
                      </a>
                      <a class="dropdown-item" href="#">
                        <i class="tio-blocked dropdown-item-icon"></i> Chặn trang và thông tin này
                      </a>
                      <a class="dropdown-item" href="#">
                        <i class="tio-info-outined dropdown-item-icon"></i> Gợi ý chỉnh sửa
                      </a>
                      ...
                      <a class="dropdown-item" href="#">
                        <i class="tio-report-outlined dropdown-item-icon"></i> Báo cáo
                      </a>
                    </div>
                  </div>
                  <!-- End Unfold -->
            ...
            <div class="row">
              <div class="col-lg-4">
                ...
                <div class="card card-body mb-3 mb-lg-5">
                  <h5>Hoàn thành hồ sơ cá nhân của bạn</h5>
                ...
                <div class="js-sticky-block card mb-3 mb-lg-5" data-hs-sticky-block-options='{
                  ...
                  <div class="card-header">
                    <h5 class="card-header-title">Hồ sơ </h5>
                  </div>
                  <!-- End Header -->
                  ...
                  <div class="card-body">
                    <ul class="list-unstyled list-unstyled-py-3 text-dark mb-3">
                      ...
                      <li>
                        ...
                        {{ $admin_by_code['fullname'] }}
                      </li>
                      <li>
                        <i class="tio-briefcase-outlined nav-icon"></i>
                        {{ $admin_by_code['department'] }}
                      </li>
                      <li>
                      ...
                      <li class="pt-2 pb-0">
                        <small class="card-subtitle">Đội nhóm</small>
                      </li>

                      <li>
                        <i class="tio-group-equal nav-icon"></i>
                        Thành viên trong 8 nhóm
                      </li>
                      <li>
                        <i class="tio-briefcase-outlined nav-icon"></i>
                        Làm việc trong 20 dự án
                      </li>
                    </ul>
                  </div>
                  <!-- End Body -->
              ...
              <div class="col-lg-8">
                ...
                <div class="card mb-3 mb-lg-5">
                  <!-- Header -->
                  <div class="card-header">
                    <h5 class="card-header-title">Hoạt động</h5>
                    ...
                    <div class="hs-unfold">
                      ...
                      <div id="contentActivityStreamDropdown" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right mt-1">
                        ...
                        <a class="dropdown-item" href="#">
                          <i class="tio-share dropdown-item-icon"></i> Chia sẻ liên kết
                        </a>
                        <a class="dropdown-item" href="#">
                          <i class="tio-info-outined dropdown-item-icon"></i> Gợi ý chỉnh sửa
                        </a>
                      ...
                      <li class="step-item">
                        <div class="step-content-wrapper">
                          ...
                          <div class="step-content">
                            <h5 class="mb-1">
                              <a class="text-dark" href="#">Báo cáo công việc - Báo cáo công việc hàng tuần</a>
                            </h5>

                            <p class="font-size-sm mb-1">Đã thêm 3 files báo cáo <a class="text-uppercase" href="#"><i class="tio-folder-bookmarked"></i> Fd-7</a></p>
                          ...
                          <div class="step-content">
                            ...
                            <ul class="list-group">
                              ...
                              <li class="list-group-item list-group-item-light">
                                <div class="row gx-1">
                                  <div class="col">
                                    <img class="img-fluid rounded ie-card-img" src="{{_WEB_ROOT.'/public/admin/svg\illustrations\card-1.svg'}}" alt="Image Description">
                                  </div>
                                  <div class="col">
                                    <img class="img-fluid rounded ie-card-img" src="{{_WEB_ROOT.'/public/admin/svg\illustrations\card-2.svg'}}" alt="Image Description">
                                  </div>
                                  <div class="col">
                                    <img class="img-fluid rounded ie-card-img" src="{{_WEB_ROOT.'/public/admin/svg\illustrations\card-3.svg'}}" alt="Image Description">
                                  </div>
                                  <div class="col">
                                    <img class="img-fluid rounded ie-card-img" src="{{_WEB_ROOT.'/public/admin/svg\illustrations\card-4.svg'}}" alt="Image Description">
                                  </div>
                                  <div class="col">
                                    <img class="img-fluid rounded ie-card-img" src="{{_WEB_ROOT.'/public/admin/svg\illustrations\card-5.svg'}}" alt="Image Description">
                                  </div>
                    ...
                    <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>
                            <div class="d-flex">
                              <img class="avatar avatar-xs" src="{{_WEB_ROOT.'/public/admin/svg\brands\spec.svg'}}" alt="Image Description">
                              <div class="ml-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex">
                              <img class="avatar avatar-xs" src="{{_WEB_ROOT.'/public/admin/svg\brands\capsule.svg'}}" alt="Image Description">
                              <div class="ml-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex">
                              <img class="avatar avatar-xs" src="{{_WEB_ROOT.'/public/admin/svg\brands\mailchimp.svg'}}" alt="Image Description">
                              <div class="ml-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex">
                              <img class="avatar avatar-xs" src="{{_WEB_ROOT.'/public/admin/svg\brands\figma.svg'}}" alt="Image Description">
                              <div class="ml-3">
