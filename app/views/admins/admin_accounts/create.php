<!-- ========== MAIN CONTENT ========== -->
    ...
    <main id="content" role="main" class="main">
      ...
      <div class="content container-fluid">
        <!-- Step Form -->
        <form id = "form-ce" class="js-step-form py-md-5" enctype="multipart/form-data" method = "POST" action = "{{_WEB_ROOT.'/admin-accounts-store'}}" data-hs-step-form-options='{
              ...
              <ul id="addUserStepFormProgress" class="js-step-progress step step-sm step-icon-sm step step-inline step-item-between mb-3 mb-md-5">
                ...
                <li class="step-item">
                  <a class="step-content-wrapper" href="javascript:;" data-hs-step-form-next-options='{
                    ...
                    <div class="step-content">
                      <span class="step-title">Địa chỉ liên hệ</span>
                    </div>
                  </a>
                </li>
              ...
              <div id="addUserStepFormContent">
                ...
                <div id="addUserStepProfile" class="card card-lg active">
                  ...
                  <div class="card-body">
                      ...
                      <div class="col-sm-9">
                        <div class="d-flex align-items-center">
                          ...
                          <label class="avatar avatar-xl avatar-circle avatar-uploader mr-5" for="avatarUploader">
                            <img id="avatarImg" class="avatar-img avatarImgAdmin" src="{{_WEB_ROOT.'\public\admin\img\160x160\img1.jpg'}}" alt="Ảnh đại diện">

                            <input type="file" name = "avatar" class="js-file-attach avatar-uploader-input" id="avatarUploader" data-hs-file-attach-options='{
                                      "textTarget": ".avatarImgAdmin",
                                      "mode": "image",
                                      "targetAttr": "src",
                    ...
                    <!-- Họ và tên -->
                    <div class="row form-group">
                      <label for="fullNameLabel" class="col-sm-3 col-form-label input-label">Họ và tên <i class="tio-help-outlined text-body ml-1" data-toggle="tooltip" data-placement="top" title="Họ và tên"></i></label>

                      <div class="col-sm-9">
                        <input type="text" class="form-control form-confirm" name="fullName" id="fullNameLabel" placeholder="Nguyễn Văn Thị A" aria-label="Nguyễn Văn Thị A"
                        data-text-target = "fullNameConfirm" data-text-example = "Nguyễn Văn Thị A">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="email" class="form-control form-confirm" name="email" id="emailLabel" placeholder="nguyenvanthia@example.com" aria-label="nguyenvanthia@example.com"
                        data-text-target = "emailConfirm" data-text-example = "nguyenvanthia@example.com">
                        <span class = "form-message">
                          {!form_error('email')!} 
                        </span>
                      </div>
                    ...
                    <div class="row form-group">
                      <label for="userNameLabel" class="col-sm-3 col-form-label input-label">
                        Tên đăng nhập
                        <i class="tio-help-outlined text-body ml-1" data-toggle="tooltip" data-placement="top" title="Tên đăng nhập bắt đầu bằng chữ và không chứa ký tự đặc biệt"></i>
                      </label>
                      
                      <div class="col-sm-9">
                        <input type="text" class="form-control form-confirm" name="userName" 
                        id="userNameLabel" placeholder="" aria-label=""
                        data-text-target = "userNameConfirm" data-text-example = "example">
                        <span class = "form-message">
                          {!form_error('userName')!} 
                        </span>
                      </div>
                    ...
                    <div class="row form-group">
                      <label for="passwordLabel" class="col-sm-3 col-form-label input-label">
                        Mật khẩu
                        <i class="tio-help-outlined text-body ml-1" data-toggle="tooltip" data-placement="top" title="Mật khẩu phải bao gồm chữ, số, CHỮ VIẾT HOA"></i>
                      </label>
                      
                      <div class="col-sm-9">
                        <input type="password" class="form-control" name="password" id="passwordLabel" placeholder="" aria-label="">
                        <span class = "form-message">
                          {!form_error('password')!} 
                        </span>
                      </div>
                    ...
                    <div class="row form-group">
                      <label for="confirmPasswordLabel" class="col-sm-3 col-form-label input-label">
                        Xác nhận Mật khẩu
                        <i class="tio-help-outlined text-body ml-1" data-toggle="tooltip" data-placement="top" title="Mật khẩu phải trùng với mật khẩu đã nhập"></i>
                      </label>
                      
                      <div class="col-sm-9">
                        <input type="password" class="form-control" name="confirmPassword" id="confirmPasswordLabel" placeholder="" aria-label="">
                        <span class = "form-message">
                    ...
                    <div class="js-add-field row form-group" data-hs-add-field-options='{
                      ...
                      <label for="phoneLabel" class="col-sm-3 col-form-label input-label">Số điện thoại <span class="input-label-secondary">(Tùy chọn)</span></label>

                      <div class="col-sm-9">
                        <div class="input-group input-group-sm-down-break align-items-center">
                          <input type="text" class="js-masked-input form-control form-confirm" name="phone" id="phoneLabel" placeholder="+x(xxx)xxx-xx-xx" aria-label="+x(xxx)xxx-xx-xx" data-hs-mask-options='{
                                   "template": "(+84) 000 000 000"
                                 }'
                          data-text-target = "phoneConfirm" data-text-example = "(+84) 000 000 000">
                        ...
                        <a class="js-create-field form-link btn btn-sm btn-no-focus btn-ghost-primary" href="javascript:;">
                          <i class="tio-add"></i> Thêm số điện thoại
                        </a>
                      </div>
                    </div>
                    <!-- End Số điện thoại -->
                    ...
                    <!-- Chức danh -->
                    <div class="row form-group">
                      <label for="jobTitleLabel" class="col-sm-3 col-form-label input-label">Chức danh</label>

                      <div class="col-sm-9">
                        <input type="text" class="form-control form-confirm" name="jobTitle" id="jobTitleLabel" placeholder="Chức danh" aria-label="Chức danh"
                        data-text-target = "jobTitleConfirm" data-text-example = "Nhân viên/Trưởng phòng">
                        <span class = "form-message">
                          {!form_error('jobTitle')!} 
                        </span>
                      </div>
                    ...
                    <!-- Bộ phận -->
                    <div class="row form-group">
                      <label for="departmentLabel" class="col-sm-3 col-form-label input-label">Bộ phận</label>

                      <div class="col-sm-9">
                        <input type="text" class="form-control form-confirm" name="department" id="departmentLabel" placeholder="Bộ phận" aria-label="Bộ phận"
                        data-text-target = "departmentConfirm" data-text-example = "Marketing/Nhân sự">
                      </div>
                    </div>
                    <!-- End Bộ phận -->
                    ...
                    <!-- Loại tài khoản -->
                    <div class="row form-group">
                      <label class="col-sm-3 col-form-label input-label">Loại tài khoản</label>
                        ...
                        <div class="input-group input-group-sm-down-break">
                          ...
                          <div class="form-control">
                            <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input form-confirm" name="userAccountTypeRadio" id="userAccountTypeRadio1" value="Quản lý" 
                              data-text-target = "userAccountTypeConfirm" 
                              data-text-example = "Nhân viên">
                              <label class="custom-control-label" for="userAccountTypeRadio1">Quản lý</label>
                            </div>
                          </div>
                          <!-- End Custom Radio -->
                          ...
                          <div class="form-control">
                            <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input form-confirm" name="userAccountTypeRadio" id="userAccountTypeRadio2" value="Quản trị viên" 
                              data-text-target = "userAccountTypeConfirm" 
                              data-text-example = "Nhân viên">
                              <label class="custom-control-label" for="userAccountTypeRadio2">Quản trị viên</label>
                            </div>
                          </div>
                          <!-- End Custom Radio -->
                        </div>
                        <span class = "form-message">
                          {!form_error('userAccountTypeRadio')!} 
                        </span>
                      </div>
                    </div>
                    <!-- End Loại tài khoản -->
                  ...
                  <div class="card-footer d-flex justify-content-end align-items-center">
                    <button type="button" class="btn btn-primary" data-hs-step-form-next-options='{
                      ...
                      Tiếp <i class="tio-chevron-right"></i>
                    </button>
                  </div>
                  <!-- End Footer -->
                </div>
                ...
                <div id="addUserStepBillingAddress" class="card card-lg" style="display: none;">
                  ...
                  <div class="card-body">
                      ...
                      <div class="col-sm-9">
                        ...
                        <div class="mb-3">
                          ...
                          data-text-example = "Việt Nam">
                            ...
                            <option value="GB" selected="" data-option-template='<span class="d-flex align-items-center"><img class="avatar avatar-xss avatar-circle mr-2" src="{{_WEB_ROOT.'/public/admin/vendor/flag-icon-css/flags/1x1/gb.svg'}}" alt="United Kingdom Flag" /><span class="text-truncate">United Kingdom</span></span>'>United Kingdom</option>
                            ...
                            <option value="VN" data-option-template='<span class="d-flex align-items-center"><img class="avatar avatar-xss avatar-circle mr-2" src="{{_WEB_ROOT.'/public/admin/vendor/flag-icon-css/flags/1x1/vn.svg'}}" alt="Vietnam Flag" /><span class="text-truncate">Vietnam</span></span>'>Vietnam</option>
                        ...
                        <div class="mb-3">
                          <input type="text" class="form-control form-confirm" name="city" id="cityLabel" placeholder="Tỉnh/Thành Phố" aria-label="Tỉnh/Thành Phố"
                          data-text-target = "cityConfirm" data-text-example = "Tỉnh thành">
                        </div>

                        <input type="text" class="form-control form-confirm" name="state" id="stateLabel" placeholder="Quận/Huyện" aria-label="Quận/Huyện"
                        data-text-target = "stateConfirm" data-text-example = "Huyện quận">
                      </div>
                    </div>
                    <!-- End Vị trí -->
                    ...
                    <!-- Địa chỉ 1 -->
                    <div class="row form-group">
                      <label for="addressLine1Label" class="col-sm-3 col-form-label input-label">Địa chỉ 1</label>

                      <div class="col-sm-9">
                        <input type="text" class="form-control form-confirm" name="addressLine1" id="addressLine1Label" placeholder="Địa chỉ của bạn" aria-label="Địa chỉ của bạn"
                        data-text-target = "addressLine1Confirm" data-text-example = "Địa chỉ 1">
                      </div>
                    </div>
                    <!-- End Địa chỉ 1 -->
                    ...
                    <div class="js-add-field row form-group" data-hs-add-field-options='{
                      ...
                      <label for="addressLine2Label" class="col-sm-3 col-form-label input-label">Địa chỉ 2 <span class="input-label-secondary">(Tùy chọn)</span></label>

                      <div class="col-sm-9">
                        <input type="text" class="form-control form-confirm" name="addressLine2" id="addressLine2Label" placeholder="Your address" aria-label="Your address"
                        data-text-target = "addressLine2Confirm" data-text-example = "Địa chỉ 2">
                        ...
                        <a href="javascript:;" class="js-create-field form-link btn btn-sm btn-no-focus btn-ghost-primary">
                          <i class="tio-add"></i> Thêm địa chỉ
                        </a>
                      </div>
                    </div>
                    <!-- End Địa chỉ 2 -->
                    ...
                    <!-- Mã bưu điện -->
                    <div class="row">
                      <label for="postalCodeLabel" class="col-sm-3 col-form-label input-label">Mã bưu điện <i class="tio-help-outlined text-body ml-1" data-toggle="tooltip" data-placement="top" title="You can find your code in a postal address."></i></label>

                      <div class="col-sm-9">
                        <input type="text" class="js-masked-input form-control form-confirm" name="postalCode" id="postalCodeLabel" placeholder="Mã bưu điện" aria-label="Mã bưu điện" data-hs-mask-options='{
                                 "template": "AA0 0AA"
                               }'
                        data-text-target = "postalCodeConfirm" data-text-example = "AA0 0AA">
                      </div>
                    </div>
                    <!-- End Mã bưu điện -->
                  </div>
                ...
                <div id="addUserStepConfirmation" class="card card-lg" style="display: none;">
                  ...
                  <div class="profile-cover">
                    <div class="profile-cover-img-wrapper">
                              <img class="profile-cover-img" src="{{_WEB_ROOT.'\public\admin\img\1920x400\img1.jpg'}}" alt="Image Description">
                    </div>
                  </div>
                  <!-- End Profile Cover -->
                  ...
                  <div class="avatar avatar-xxl avatar-circle avatar-border-lg profile-cover-avatar">
                            <img class="avatar-img avatarImgAdmin" src="{{_WEB_ROOT.'\public\admin\img\160x160\img9.jpg'}}" alt="Ảnh đại diện">
                  </div>
                  <!-- End Avatar -->
                  ...
                  <div class="card-body">
                    <dl class="row">
                      <dt class="col-sm-6 text-sm-right">Họ và tên:</dt>
                      <dd id = "fullNameConfirm" class="col-sm-6">Ella Lauda</dd>

                      <dt class="col-sm-6 text-sm-right">Email:</dt>
                      <dd id = "emailConfirm" class="col-sm-6">ella@example.com</dd>

                      <dt class="col-sm-6 text-sm-right">Tên đăng nhập:</dt>
                      <dd id = "userNameConfirm" class="col-sm-6">+1 (609) 972-22-22</dd>

                      <dt class="col-sm-6 text-sm-right">Số điện thoại:</dt>
                      <dd id = "phoneConfirm" class="col-sm-6">+1 (609) 972-22-22</dd>

                      <dt class="col-sm-6 text-sm-right">Chức danh:</dt>
                      <dd id = "jobTitleConfirm" class="col-sm-6">Htmlstream</dd>

                      <dt class="col-sm-6 text-sm-right">Bộ phận:</dt>
                      <dd id = "departmentConfirm" class="col-sm-6">-</dd>

                      <dt class="col-sm-6 text-sm-right">Loại tài khoản:</dt>
                      <dd id = "userAccountTypeConfirm" class="col-sm-6">Individual</dd>

                      <dt class="col-sm-6 text-sm-right">Quốc gia:</dt>
                      <dd id = "locationConfirm" class="col-sm-6">
                        <img class="avatar avatar-xss avatar-circle mr-1" src="{{_WEB_ROOT.'\public\admin\vendor\flag-icon-css\flags\1x1\gb.svg'}}" alt="Great Britain Flag"> 
                        United Kingdom
                      </dd>

                      <dt class="col-sm-6 text-sm-right">Tỉnh/Thành phố:</dt>
                      <dd id = "cityConfirm" class="col-sm-6">London</dd>

                      <dt class="col-sm-6 text-sm-right">Quận/Huyện:</dt>
                      <dd id = "stateConfirm" class="col-sm-6">-</dd>

                      <dt class="col-sm-6 text-sm-right">Địa chỉ 1:</dt>
                      <dd id = "addressLine1Confirm" class="col-sm-6">45 Roker Terrace, Latheronwheel</dd>

                      <dt class="col-sm-6 text-sm-right">Địa chỉ 2:</dt>
                      <dd id = "addressLine2Confirm" class="col-sm-6">-</dd>

                      <dt class="col-sm-6 text-sm-right">Mã bưu điện:</dt>
                      <dd id = "postalCodeConfirm" class="col-sm-6">KW5 8NW</dd>
                    </dl>
                    <!-- End Row -->
                  </div>
                  <!-- End Body -->
                  ...
                  <div class="card-footer d-sm-flex align-items-sm-center">
                    ...
                    <div class="ml-auto">
                      <button id="addUserFinishBtn" type="submit" class="btn btn-primary">Thêm quản trị viên</button>
                    </div>
                  </div>
                  <!-- End Footer -->
                </div>
              ...
              <!-- Message Body -->
                <div id="successMessageContent" style="display: none">
                  <div class="text-center">
                    <img class="img-fluid mb-3" alt="Thành công" 
                    src="{{_WEB_ROOT.'\public\admin\svg\illustrations\hi-five.svg'}}" style="max-width: 15rem;">

                    <div class="mb-4">
                      <h2>Thành công!</h2>
                      <p>Mới <span class="font-weight-bold text-dark">Ella Lauda</span> quản trị viên đã được tạo thành công</p>
                    </div>

                    <div class="d-flex justify-content-center">
                      <a class="btn btn-white mr-3" href="{{_WEB_ROOT.'/admin-accounts'}}">
                        <i class="tio-chevron-left ml-1"></i> Quay lại danh sách
                      </a>
