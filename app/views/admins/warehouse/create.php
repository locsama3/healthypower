            ...
            <div class="col-sm mb-2 mb-sm-0">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-no-gutter">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Thêm kho hàng mới</li>
                </ol>
              </nav>

              <h1 class="page-header-title">Thêm kho hàng</h1>
            </div>
          </div>
          <!-- End Row -->
        </div>
          ...
          <div class="mx-auto col-lg-8">
            ...
            <div class="card mb-3 mb-lg-5">
              ...
              <div class="card-body">
                ...
                <!-- Quill -->
                <textarea name="warehouse_desc" id="ckeditor1" cols="30" rows="10" placeholder="Mô tả"></textarea>
                <!-- End Quill -->
              </div>
              <!-- Body -->
            </div>
