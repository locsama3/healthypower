<!-- ========== MAIN CONTENT ========== -->
    ...
    <main id="content" role="main" class="main">
      <!-- Content -->
      <form id ="form-ce" class="content container-fluid" method="POST"  enctype="multipart/form-data" data-uptid = "{{$warehouse_by_id['id']}}">
        {!csrf_field()!}
        <!-- Page Header -->
            ...
            <div class="col-sm mb-2 mb-sm-0">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-no-gutter">
                  <li class="breadcrumb-item"><a class="breadcrumb-link" href="ecommerce-products.html">Kho hàng</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Cập nhật kho hàng</li>
                </ol>
              </nav>

              <h1 class="page-header-title">Cập nhật kho hàng</h1>
            </div>
          </div>
          <!-- End Row -->
        </div>
            ...
            <div class="card mb-3 mb-lg-5">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <label for="title" class="input-label">Tên kho hàng <i class="tio-help-outlined text-body ml-1" data-toggle="tooltip" data-placement="top" title="Tên danh mục"></i></label>

                  <input type="text" class="form-control" name="warehouseName" id="title" 
                  value="{{$warehouse_by_id['store_name']}}" onkeyup="setTimeout(ChangeToSlug(),2000)">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="slug" id="convert_slug" value="{{$warehouse_by_id['slug']}}">
                </div>
                <!-- End Liên kết tĩnh -->
                ...
                <div class="form-group">
                  ...
                  value="{{$warehouse_by_id['store_code']}}">
                </div>
                <!-- End mã kho -->

                <!-- Tiêu đề website -->
                <div class="form-group">
                  <label for="pageTitle" class="input-label-secondary">Tùy chỉnh tiêu đề site <i class="tio-help-outlined text-body ml-1" data-toggle="tooltip" data-placement="top" title="Tiêu đề site"></i></label>

                  <input type="text" class="form-control" name="pageTitle" id="pageTitle" value="{{$warehouse_by_id['page_title']}}">
                </div>
                <!-- End Tiêu đề website -->
                
                <label class="input-label">Mô tả kho hàng <span class="input-label-secondary">(Tùy chọn)</span></label>

                <!-- Quill -->
                <textarea name="warehouse_desc" id="ckeditor1" cols="30" rows="10" placeholder="Mô tả">{{$warehouse_by_id['description']}}</textarea>
                <!-- End Quill -->
              </div>
              <!-- Body -->
            </div>
                ...
                <div id="fancyboxGallery" class="js-fancybox row justify-content-sm-center gx-2" data-hs-fancybox-options='{
                  ...
                  <div class="col-6 col-sm-4 col-md-3 mb-3 mb-lg-5">
                    ...
                    <div class="card card-sm">
                      <img class="card-img-top" src="{{_WEB_ROOT.'/public/uploads/warehouse/'.$warehouse_by_id['image']}}" alt="Image Description">
