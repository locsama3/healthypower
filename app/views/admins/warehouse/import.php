    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center mb-3">
                <div class="col-sm">
                    <h1 class="page-header-title">Danh sách nhập kho</h1>
                ...
                <div class="col-sm-auto">
                     <button onclick="location.href=`{{_WEB_ROOT.'/warehouse-import-create'}}`;" class="btn btn-success">Tạo phiếu nhập</button>
                </div>
                ...
                <table id="datatable" class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table" style="width: 100%" data-hs-datatables-options='{
                    ...
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="table-column-pl-0">Mã nhập hàng</th>
    ...
    <div class="modal-content" style="width:700px">
      ...
      <div class="modal-body">
        <table class="table table-sm">
          ...
          <tbody>
            @foreach($import_detail as $value)
            @php $i = 0; @endphp
            @foreach($value as $product)
            @if($product['import_id'] == $data['id'])
            @php $i++; @endphp
            <tr>
              <th scope="row">{{$i}}</th>
