        ...
        <div class="page-header">
          <div class="row align-items-center mb-3">
            <div class="col-sm mb-2 mb-sm-0">
              <h1 class="page-header-title">Danh sách nhà cung ứng <span class="badge badge-soft-dark ml-2"> {{ $supplierCount }} </span></h1>
            ...
            <div class="col-sm-auto">
              <a class="btn btn-primary" href="{{_WEB_ROOT.'/supplier-create'}}">Thêm nhà cung ứng</a>
            </div>
          </div>
          <!-- End Row -->
          ...
          <div class="js-nav-scroller hs-nav-scroller-horizontal">
            ...
            <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" href="#">Danh sách Nhà cung ứng</a>
              </li>
              <li class="nav-item">
                    ...
                    <div class="card card-sm">
                      <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                          <span class="mr-2">Danh sách nhà cung ứng</span>
            ...
            <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
              ...
              <thead class="thead-light">
                <tr>
                  ...
                  <th class="table-column-pl-0">Nhà cung ứng</th>
                  <th>Trạng thái</th>
                  <th>Mô tả</th>
                  <th>Actions</th>
                </tr>
              ...
              <tbody>
                @foreach ($list_supplier as $key => $value)
                <tr id = "row_tr_{{$value['id']}}">
                  ...
                  <td class="table-column-pl-0">
                    <a class="media align-items-center" href="ecommerce-product-details.html">
                      <img class="avatar avatar-lg mr-3" src="{{_WEB_ROOT.'/public/uploads/supplier/'.$value['image']}}" alt="Image Description">
                      <div class="media-body">
                        <h5 class="text-hover-primary mb-0">{{$value['supplier_name']}}</h5>
                      </div>
                    </a>
                    <p>{{$value['supplier_code']}}</p>
                  </td>
                  <td>
