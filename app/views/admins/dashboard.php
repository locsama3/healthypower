              ...
              <div class="card-body">
                ...
                <ul class="list-group list-group-flush list-group-no-gutters">
                  ...
                  <li class="list-group-item py-3">
                    <div class="media">
                      <div class="mt-1 mr-3">
                        <img class="avatar avatar-xs avatar-4by3" src="{{_WEB_ROOT.'/public/admin/svg/brands/capsule.svg'}}" alt="Image Description">
                      </div>
                  ...
                  <li class="list-group-item py-3">
                    <div class="media">
                      <div class="mt-1 mr-3">
                        <img class="avatar avatar-xs avatar-4by3" src="{{_WEB_ROOT.'/public/admin/svg/brands\mailchimp.svg'}}" alt="Image Description">
                      </div>
                      <div class="media-body">
                        <div class="row align-items-center">
                          <div class="col">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="table-column-pl-0">
                    <a class="media align-items-center" href="user-profile.html">
                      <div class="avatar avatar-sm avatar-circle mr-2">
                        <img class="avatar-img" src="{{_WEB_ROOT.'/public/admin/img/160x160\img4.jpg'}}" alt="Image Description">
                      </div>
                      <div class="media-body">
