...
<main id="content" role="main" class="main">
  ...
  <div class="content container-fluid">
    <!-- Page Header -->
    <form action="" method="post" enctype="multipart/form-data" name="formInsert">
          ...
          <div class="card-body">
            ...
            <div id="attachFilesNewProjectLabel" class="js-dropzone dropzone-custom custom-file-boxed">
              <div class="dz-message custom-file-boxed-label">
                <img class="avatar avatar-xl avatar-4by3 mb-3" src="{{_WEB_ROOT.'\public\template\svg\illustrations\browse.svg'}}" alt="Image Description">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- Media -->
        <div class="d-sm-flex">
          <img class="avatar avatar-xl avatar-4by3 mb-3 mb-sm-0 mr-4" src="{{_WEB_ROOT.'\public\template\svg\illustrations\choice.svg'}}" alt="Image Description">
        ...
        <!-- Media -->
        <div class="d-sm-flex">
          <img class="avatar avatar-xl avatar-4by3 mb-3 mb-sm-0 mr-4" src="{{_WEB_ROOT.'\public\template\svg\illustrations\presenting.svg'}}" alt="Image Description">
        ...
        <!-- Media -->
        <div class="d-sm-flex">
          <img class="avatar avatar-xl avatar-4by3 mb-3 mb-sm-0 mr-4" src="{{_WEB_ROOT.'\public\template\svg\illustrations\book.svg'}}" alt="Image Description">
