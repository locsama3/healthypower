        ...
        <div class="page-header">
          <div class="row align-items-center mb-3">
            <div class="col-sm mb-2 mb-sm-0">
              <h1 class="page-header-title">Danh sách phương thức thanh toán <span class="badge badge-soft-dark ml-2"> {{ $paymentCount }} </span></h1>
            ...
            <div class="col-sm-auto">
              <a class="btn btn-primary" href="{{_WEB_ROOT.'/payment-types-create'}}">Thêm phương thức</a>
            </div>
          </div>
          <!-- End Row -->
          ...
          <div class="js-nav-scroller hs-nav-scroller-horizontal">
            ...
            <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" href="#">Danh sách phương thức thanh toán</a>
              </li>
              <li class="nav-item">
                    ...
                    <div class="card card-sm">
                      <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                          <span class="mr-2">Danh sách phương thức</span>
            ...
            <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
              ...
              <thead class="thead-light">
                <tr>
                  ...
                  <th class="table-column-pl-0">Phương thức thanh toán</th>
                  <th>Trạng thái</th>
                  <th>Mô tả</th>
                  <th>Actions</th>
                </tr>
                ...
                <tr id = "row_tr_{{$value['id']}}">
                  ...
                  <td class="table-column-pl-0">
                    <a class="media align-items-center" href="ecommerce-product-details.html">
                      <img class="avatar avatar-lg mr-3" src="{{_WEB_ROOT.'/public/uploads/payment_type/'.$value['image']}}" alt="Image Description">
                      <div class="media-body">
                        <h5 class="text-hover-primary mb-0">{{$value['payment_name']}}</h5>
                      </div>
                    </a>
                    <p>{{$value['payment_code']}}</p>
                  </td>
                  <td>
                  ...
                  <td>
                    <div class="btn-group" role="group">
                      ...
                      href="{{_WEB_ROOT.'/payment-types-edit/editid-'.$value['id']}}">
