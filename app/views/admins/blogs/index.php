        ...
        <div class="page-header">
          <div class="row align-items-center mb-3">
            <div class="col-sm mb-2 mb-sm-0">
              <h1 class="page-header-title">Bài viết <span class="badge badge-soft-dark ml-2">1 con số</span></h1>
            ...
            <div class="col-sm-auto">
              <a class="btn btn-primary" href="ecommerce-add-product.html">Thêm bài viết</a>
            </div>
          </div>
          <!-- End Row -->
