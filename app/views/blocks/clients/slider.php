    ...
    <div class="wow">
      <div id='rev_slider_4_wrapper' class='rev_slider_wrapper fullwidthbanner-container' >
        <div id='rev_slider_4' class='rev_slider fullwidthabanner'>
          <ul>
            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='{{_WEB_ROOT."/public/clients/images/slider_img_1.html"}}'><img src='{{_WEB_ROOT."/public/clients/images/slide-img1.jpg"}}' data-bgposition='left top' data-bgfit='cover' data-bgrepeat='no-repeat' alt="banner"/>
            ...
            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='{{_WEB_ROOT."/public/clients/images/slider_img_2.jpg"}}' class="black-text"><img src='{{_WEB_ROOT."/public/clients/images/slide-img2.jpg"}}'  data-bgposition='left top'  data-bgfit='cover' data-bgrepeat='no-repeat' alt="banner"/>
